...
const preguntaBuscarUsuario = [
    {
        type: 'input',
        name: 'idUsuario',
        message: 'Ingrese Codigo de las motocilcetas',
    }
];
const preguntaUsuario = [
    {
        type: 'input',
        name: 'id',
        message: 'Cual es el codigo de las motocilcetas?'
    },
    {
        type: 'input',
        name: 'nombre',
...
const preguntaEdicionUsuario = [
    {
        type: 'input',
        name: 'nombre',
        message: 'Cual es el nuevo nombre de la motocicleta'
    },
];
...
function ejecutarAcccion() {
    ...
    (respuestaBDD) => {
        ...
        switch (opcion) {
            case 'Crear':
                const motocicletas = respuestaBDD.motocilcetas;
